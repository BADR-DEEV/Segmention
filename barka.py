...
if __name__ == "__main__":
    ...
    cfg.SOLVER.MAX_ITER = 17200
    cfg.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 32
    cfg.INPUT.MIN_SIZE_TRAIN = (512, 640, 800)  # Multi-scale training
    ...
    # Evaluate Model
    # evaluator = COCOEvaluator("mhp_val", cfg, output_dir="./output101/")
    # val_loader = build_detection_test_loader(cfg, "mhp_val")
    # inference_on_dataset(trainer.model, val_loader, evaluator)
    ...
    predictor = DefaultPredictor(cfg)
    evaluator = COCOEvaluator("mhp_val", output_dir="./output101")
    val_loader = build_detection_test_loader(cfg, "mhp_val")
    print(inference_on_dataset(predictor.model, val_loader, evaluator))
    # val_loader = build_detection_test_loader(cfg, "mhp_val")
